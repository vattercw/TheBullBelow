...
function Update()
{
	var movement = thisTransform.TransformDirection( Vector3( Input.mousePosition.x, 0, Input.mousePosition.y ) );
	...
	var absJoyPos = Vector2( Mathf.Abs( Input.mousePosition.x ), Mathf.Abs( Input.mousePosition.y ) );	
